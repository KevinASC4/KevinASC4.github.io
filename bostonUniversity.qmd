...
Overall, this course significantly enhanced my problem-solving abilities and provided me with a solid foundation for future studies in computer science and data analytics. Below is my final report in power point.

[Summary](CS566-FinalProject.qmd)
...
Additionally, I was required to choose a topic for a final project, which I presented on the last day of class. This project allowed me to apply my skills to a comprehensive data analysis problem, enhancing both my technical abilities and presentation skills. In the scripts linked below, I recreated provided graphs using seaborn, matplotlib, numpy, and pandas.
